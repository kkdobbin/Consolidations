#Data compilation for descriptive consolidations analysis

#Load libraries
library(tidyverse)

#load data
Master <- read_csv("Data/Master_copy_2.28.22.csv")
...
Master <- Master %>% filter(`Remove?` == "No")

#write CSV
write.csv(Master, file = "Outputs/CompiledFeb28.csv", row.names = FALSE)
