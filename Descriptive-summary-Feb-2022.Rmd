...
Of the 229 cases we identify, `r Data %>% filter(Physical_or_Mangerial == "Managerial") %>% tally()` were managerial consolidations, the remaining `r Data %>% filter(Physical_or_Mangerial == "Physical") %>% tally()` were physical consolidations. Our data set consists of only `r Data %>% filter(Mandatory_or_voluntary == "Mandatory") %>% tally()` mandatory consolidations (Pratt MWC and Ceres West MHP) with the remainder being voluntary consolidations.  
